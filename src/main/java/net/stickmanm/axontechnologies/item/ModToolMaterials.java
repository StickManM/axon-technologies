...
public enum ModToolMaterials implements ToolMaterial {
    ...
    CORRUPTINITE_AXON_ALLOY(10, 0, 45.0f, 17.5f, 100, () -> Ingredient.ofItems(ModItems.CORRUPTINITE)),
    DARK_THUNDERANIUM_AXON_ALLOY(10, 0, 50.0f, 19.0f, 115, () -> Ingredient.ofItems(ModItems.DARK_THUNDERANIUM_INGOT)),
    AXON_ALLOY(10, 0, 40.0f, 16.5f, 90, () -> Ingredient.ofItems(ModItems.AXON_ALLOY)),
