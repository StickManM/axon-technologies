...
import net.stickmanm.axontechnologies.item.client.AxonAlloyArmorRenderer;
...
public class AxonAlloyArmorItem extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);


    public AxonAlloyArmorItem(ArmorMaterial material, Type type, Settings settings) {
        super(material, type, settings);
    }
    @Override
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private AxonAlloyArmorRenderer renderer;
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                ...
                if (this.renderer == null)
                    this.renderer = new AxonAlloyArmorRenderer();
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        if(!world.isClient()) {
            if(entity instanceof PlayerEntity player) {
                ...
                if (headPiece.isOf(ModItems.AXON_ALLOY_HELMET) &&
                        chestPiece.isOf(ModItems.AXON_ALLOY_CHESTPLATE) &&
                        legPiece.isOf(ModItems.AXON_ALLOY_LEGGINGS) &&
                        footPiece.isOf(ModItems.AXON_ALLOY_BOOTS)) {
                    ...
                    if(player.hasStatusEffect(ModEffects.ANTI_CORRUPTED_GLITCHSTER)) {
                        ...
                        player.addStatusEffect(new StatusEffectInstance(ModEffects.CORRUPTED_GLITCHSTERII, 200, 0, false, false, true));
                        player.addStatusEffect(new StatusEffectInstance(ModEffects.GLITCHSTERIV, 200, 0, false, false, true));
