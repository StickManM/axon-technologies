...
import net.stickmanm.axontechnologies.item.client.DarkThunderaniumAxonAlloyArmorRenderer;
...
public class DarkThunderaniumAxonAlloyArmorItem extends ArmorItem implements GeoItem {

    private final AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);
    private final Supplier<Object> renderProvider = GeoItem.makeRenderer(this);


    public DarkThunderaniumAxonAlloyArmorItem(ArmorMaterial material, Type type, Settings settings) {
        super(material, type, settings);
    }
    @Override
    public void createRenderer(Consumer<Object> consumer) {
        consumer.accept(new RenderProvider() {
            private DarkThunderaniumAxonAlloyArmorRenderer renderer;
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                ...
                if (this.renderer == null)
                    this.renderer = new DarkThunderaniumAxonAlloyArmorRenderer();
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        ...
        if(!world.isClient()) {
            if(entity instanceof PlayerEntity player) {
                ...
                if (headPiece.isOf(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_HELMET) &&
                        chestPiece.isOf(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_CHESTPLATE) &&
                        legPiece.isOf(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_LEGGINGS) &&
                        footPiece.isOf(ModItems.DARK_THUNDERANIUM_AXON_ALLOY_BOOTS)) {
