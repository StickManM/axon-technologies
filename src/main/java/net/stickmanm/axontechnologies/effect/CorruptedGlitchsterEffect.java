        ...
        if(entity.hasStatusEffect(ModEffects.ANTI_CORRUPTED_GLITCHSTER)) {
            if (!entity.getWorld().isClient()) {
                addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", 1f, EntityAttributeModifier.Operation.MULTIPLY_TOTAL)
                        .addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 5f, EntityAttributeModifier.Operation.ADDITION)
                        ...
                        .addAttributeModifier(EntityAttributes.GENERIC_LUCK, "AF8B6E3F-3328-4C0A-AA36-5BA2BB9DBEF3", 30, EntityAttributeModifier.Operation.MULTIPLY_TOTAL);
            }
        }
