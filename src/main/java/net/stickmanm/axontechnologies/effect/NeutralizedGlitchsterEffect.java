    ...
    public void applyUpdateEffect(LivingEntity entity, int Amplifier) {
            ...
            if (!entity.getWorld().isClient()) {
                ...
                addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE, "648D7064-6A60-4F59-8ABE-C2C23A6DD7A9", 3f, EntityAttributeModifier.Operation.ADDITION)
                        ...
                        .addAttributeModifier(EntityAttributes.GENERIC_MOVEMENT_SPEED, "91AEAA56-376B-4498-935B-2F7F68070635", 1.0f, EntityAttributeModifier.Operation.MULTIPLY_TOTAL)
