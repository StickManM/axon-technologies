...
public class ModRecipeGenerator extends FabricRecipeProvider {
    ...
    @Override
    public void generate(RecipeExporter exporter) { //cool comment
       ...
       //IGNITERS
        ...
        // offerCompactingRecipe(exporter, RecipeCategory.MISC, ModItems.INFINITE_WATER_BUCKET, Items.WATER_BUCKET);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RAZZORIUM)
                ...
                .input('Q', ModItems.AXON_ALLOY_AXE)
                .input('B', ModItems.AXON_ALLOY_SWORD)
                .input('J', ModItems.AXON_ALLOY_PICKAXE)
                .criterion(FabricRecipeProvider.hasItem(ModItems.CORRUPTINITE),
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.BOMB_STICK)
                ...
                .offerTo(exporter, new Identifier(FabricRecipeProvider.getRecipeName(ModItems.BOMB_STICK)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.NATEY_GIFT)
                ...
                .offerTo(exporter, new Identifier(FabricRecipeProvider.getRecipeName(ModItems.NATEY_GIFT)));
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, ModBlocks.OCTUPLE_COMPRESSED_COBBLESTONE)
                ...
                .offerTo(exporter, new Identifier(FabricRecipeProvider.getRecipeName(ModBlocks.OCTUPLE_COMPRESSED_COBBLESTONE)));
